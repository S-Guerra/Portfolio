...
function Footer() {
    ...
    return (
        <footer className="page-section" id="footer">
            ...
            <p>{t("footer.license")}<a target="_blank" rel="noreferrer" href="https://www.mozilla.org/media/MPL/2.0/index.f75d2927d3c1.txt">Mozilla Public License, v. 2.0.</a></p>
        </footer >
    )
}
